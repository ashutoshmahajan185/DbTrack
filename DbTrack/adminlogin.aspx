                ...
                <div class="module module-login span4 offset4">
                    <form id="form1" runat="server">
                        ...
                        <div class="module-body">
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* Password Required" ForeColor="Red" ControlToValidate="TextBox2" />
                            <br />
                            <br />
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="  Login  " Width="33%" class="btn btn-primary pull-center" />
                            <br />
                            <br />
